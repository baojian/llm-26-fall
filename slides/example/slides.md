...
Note:
This short sample demonstrates the lecture format. It is not a complete plan for the first class.
...
- [Sennrich, Haddow, and Birch (2016)](https://aclanthology.org/P16-1162/)<br>Read Section 3.2 for the BPE-based subword method.
